...
<section class="container-shell section-space">
	...
	<div class="grid gap-6 lg:grid-cols-3">
		<div class="surface-card p-7">
			<h2 class="font-display text-2xl text-ink">Made to be useful</h2>
		...
		<div class="surface-card p-7">
			<h2 class="font-display text-2xl text-ink">Local tone first</h2>
			<p class="mt-4 text-sm leading-7 text-ink/72">
				The site is meant to sound calm, direct and local rather than promotional or overworked.
			</p>
		</div>
	</div>
</section>
