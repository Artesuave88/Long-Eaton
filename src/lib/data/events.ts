...
const baseEvents: EventItem[] = [
  ...
  {
    id: "event-derby-county-u21-west-bromwich-albion-u21-2026-08-31",
    slug: "derby-county-u21-west-bromwich-albion-u21-31-august-2026",
    title: "Derby County U21 vs West Bromwich Albion U21",
    date: "2026-08-31",
    time: "13:00",
    startTime: "13:00",
    location: "Grange Park, Station Road, Long Eaton, NG10 2EF",
    organiser: "Derby County Football Club",
    category: "Sport",
    tags: ["Football", "Bank Holiday", "Grange Park"],
    excerpt:
      "Derby County's under-21 side hosts West Bromwich Albion under-21s at Grange Park on Bank Holiday Monday.",
    description: [
      "Derby County U21 face West Bromwich Albion U21 in a Premier League 2 fixture at Grange Park.",
      "Kick-off is at 1pm on Bank Holiday Monday. Check the official match page for the latest ticket and admission information before travelling.",
    ],
    imageSrc: "/derby-county-u21-west-bromwich.png",
    imageAlt: "Premier League football on the pitch",
    imageLabel: "Football at Grange Park",
    imageStyle: "bg-brand-section",
    sourceUrl:
      "https://www.dcfc.co.uk/news/2026/08/pre-match-raymond-offor-west-bromwich-albion-u21-h",
    featured: true,
  },
  {
    id: "event-liv-driver-harrington-arms-2026-08-31",
    slug: "liv-driver-harrington-arms-31-august-2026",
    title: "Liv Driver at the Harrington Arms Beer & Cider Festival",
    date: "2026-08-31",
    time: "Live music from 14:30; kitchen from 12:00",
    startTime: "14:30",
    location: "Harrington Arms, 392 Tamworth Road, Sawley, NG10 3AU",
    organiser: "Harrington Arms Beer, Cider and Gin Festival",
    performer: "Liv Driver",
    category: "Music",
    tags: ["Live music", "Beer festival", "Bank Holiday", "Sawley"],
    excerpt:
      "Liv Driver closes the Harrington Arms' 26th annual Beer & Cider Festival with a relaxed acoustic set.",
    description: [
      "The Harrington Arms rounds off its 26th annual Beer & Cider Festival on Bank Holiday Monday with live music from Liv Driver.",
      "The acoustic set is advertised for 2:30pm, with the pub kitchen open from noon.",
    ],
    imageSrc: "/liv-driver-harrington-arms.png",
    imageAlt: "Liv Driver singing and playing acoustic guitar",
    imagePosition: "center 30%",
    imageLabel: "Live music at the Harrington Arms",
    imageStyle: "bg-brand-accent/10",
    sourceUrl: "https://happeningnext.com/event/liv-driver-eid3a0e0ajg3x",
    featured: true,
  },
  {
    id: "event-eaton-farm-poker-night-2026-08-31",
    slug: "eaton-farm-poker-night-31-august-2026",
    title: "Poker Night at The Eaton Farm",
    date: "2026-08-31",
    time: "19:00",
    startTime: "19:00",
    location: "The Eaton Farm, Long Eaton",
    organiser: "The Eaton Farm",
    category: "Social",
    tags: ["Poker", "Pub", "Bank Holiday"],
    excerpt:
      "A Monday evening poker night listed at The Eaton Farm for the August bank holiday.",
    description: [
      "The Eaton Farm's regular poker night is listed for 7pm on Bank Holiday Monday.",
      "As this listing comes from a local pub-events directory, confirm the bank-holiday arrangements with the venue before attending.",
    ],
    locationNote: "Check with the venue before travelling.",
    imageSrc: "/eaton-farm-poker-night.png",
    imageAlt: "A royal flush of hearts held over poker chips on green felt",
    imageLabel: "Poker night at The Eaton Farm",
    imageStyle: "bg-brand-section",
    sourceUrl: "https://thruddle.com/whats-on/long-eaton",
    featured: false,
  },
  {
    id: "event-sportsman-food-quiz-2026-08-31",
    slug: "sportsman-food-quiz-night-31-august-2026",
    title: "Food Quiz Night and Free Pool at The Sportsman",
    date: "2026-08-31",
    time: "20:00",
    startTime: "20:00",
    location: "The Sportsman, Long Eaton",
    organiser: "The Sportsman",
    category: "Quiz",
    tags: ["Quiz", "Free pool", "Pub", "Bank Holiday"],
    excerpt:
      "A food quiz night with free pool, listed at The Sportsman on Bank Holiday Monday.",
    description: [
      "The Sportsman's regular food quiz night and free pool are listed from 8pm on Bank Holiday Monday.",
      "As this listing comes from a local pub-events directory, confirm the bank-holiday arrangements with the venue before attending.",
    ],
    locationNote: "Check with the venue before travelling.",
    imageSrc: "/sportsman-long-eaton.png",
    imageAlt: "The Sportsman pub exterior in Long Eaton",
    imageLabel: "Quiz night at The Sportsman",
    imageStyle: "bg-brand-section",
    sourceUrl: "https://thruddle.com/whats-on/long-eaton",
    featured: false,
  },
  {
    id: "event-grantham-town-long-eaton-united-2026-08-31",
    slug: "grantham-town-v-long-eaton-united-31-august-2026",
    title: "Grantham Town vs Long Eaton United",
    date: "2026-08-31",
    time: "15:00",
    startTime: "15:00",
    location: "South Kesteven Sports Stadium, Trent Road, Grantham, NG31 7XQ",
    price: "Adults £10; concessions £7; ages 14–17 £4; under-14s free",
    priceSummary:
      "Under-14s enter free when accompanied by an adult. Other admission prices are adults £10, concessions £7 and ages 14–17 £4.",
    organiser: "Long Eaton United Football Club",
    category: "Sport",
    tags: ["Football", "Away fixture", "Bank Holiday"],
    excerpt:
      "Long Eaton United travels to Grantham Town for a Northern Premier League Midlands fixture on Bank Holiday Monday.",
    description: [
      "Long Eaton United's first team faces Grantham Town away in the Northern Premier League Midlands Division One.",
      "The club estimates the trip from Long Eaton at around 30 miles, with a journey time of approximately 45 minutes.",
    ],
    locationNote: "This is an away fixture in Grantham.",
    imageSrc: "/grantham-town-long-eaton-united.png",
    imageAlt: "Match preview artwork for Grantham Town against Long Eaton United",
    imageLabel: "Long Eaton United away at Grantham Town",
    imageStyle: "bg-brand-section",
    sourceUrl:
      "https://www.longeatonutd.co.uk/teams/28954/match-centre/1-19938014",
    featured: false,
  },
  {
