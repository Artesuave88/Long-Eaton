...
export const businesses: BusinessItem[] = [
  {
    ...
    description:
      "Easy-going cafe for brunch, coffee and a quick lunch in town.",
    about: [
  ...
  },
  {
    ...
    description:
      "Bike shop for repairs, accessories and route advice before heading out.",
    about: [
  ...
  },
  {
    ...
    description:
      "Small gift shop with cards, home bits and a few locally made finds.",
    about: [
  ...
  },
  {
    ...
    location: "Derby Road",
    description:
      "Pilates and yoga classes in a calm studio just off Derby Road.",
    about: [
  ...
  },
  {
    ...
    description:
      "Independent bookshop with local interest titles, children's shelves and regular events.",
    about: [
  ...
  },
  {
    ...
    description:
      "Florist for seasonal bouquets, event flowers and everyday deliveries.",
    about: [
