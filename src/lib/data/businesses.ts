...
const baseBusinesses: BusinessItem[] = [
  {
    id: "business-26",
    slug: "cleaver-cafe-bar",
    name: "Cleaver Café & Bar",
    category: "Food & Drink",
    location: "Westgate, Clifford Street, Long Eaton, NG10 1EF",
    description:
      "An independent café and bar in a former Victorian textile mill, serving brunch, all-day breakfasts, barista coffee and cocktails.",
    about: [
      "Cleaver Café & Bar is housed in a former Victorian textile mill at Westgate in the centre of Long Eaton.",
      "The daytime menu includes relaxed brunches, all-day breakfasts, barista-style coffee and cakes, while Friday and Saturday evenings bring cocktails, happy hour and a full bar menu.",
      "The venue also hosts bottomless brunches and regular events, welcomes dogs, and keeps some tables available for walk-in customers.",
    ],
    website: "https://www.cleavercafebar.com/",
    instagram: "https://www.instagram.com/cleavercafebar/",
    telephone: "0115 684 9349",
    email: "info@cleavercafebar.com",
    openingHours: [
      { label: "Monday–Saturday: 9am–3.30pm", schema: "Mo-Sa 09:00-15:30" },
      {
        label: "Friday–Saturday bar service: 4pm–11pm",
        schema: "Fr-Sa 16:00-23:00",
      },
    ],
    imageAlt: "Cleaver Café & Bar",
    imageLabel: "Independent café and bar",
    imageStyle: "bg-[#e7ddd1]",
    featured: false,
    isReal: true,
  },
  {
    id: "business-25",
    slug: "ageno-restaurant",
    name: "Ageno",
    category: "Food & Drink",
    location: "20 Derby Road, Long Eaton, NG10 1LW",
    description:
      "A Long Eaton restaurant serving Nepalese and Indian dishes, with evening dining, takeaway ordering and a Sunday buffet.",
    about: [
      "Ageno is a Nepalese and Indian restaurant on Derby Road in Long Eaton, offering a menu built around traditional dishes, bold spices and warm hospitality.",
      "Customers can dine in, book a table or order takeaway online, with evening opening from Tuesday to Saturday.",
      "On Sundays, the restaurant opens from lunchtime and offers a buffet service.",
    ],
    website: "https://ageno.co.uk/",
    telephone: "0115 972 8481",
    email: "info@ageno.co.uk",
    openingHours: [
      { label: "Monday: Closed", schema: "Mo off" },
      { label: "Tuesday–Thursday: 4.30pm–10pm", schema: "Tu-Th 16:30-22:00" },
      { label: "Friday–Saturday: 4.30pm–11pm", schema: "Fr-Sa 16:30-23:00" },
      { label: "Sunday: 1pm–9pm", schema: "Su 13:00-21:00" },
    ],
    imageAlt: "Ageno Restaurant",
    imageLabel: "Nepalese and Indian restaurant",
    imageStyle: "bg-[#efe2d1]",
    featured: false,
    isReal: true,
  },
  {
    id: "business-24",
    slug: "erewash-valley-gymnastics-club",
    name: "Erewash Valley Gymnastics Club",
    category: "Fitness & Sport",
    location: "New Tythe Street, Long Eaton, NG10 2DL",
    description:
      "A community gymnastics club and registered charity offering coaching and activities for a wide range of ages and abilities.",
    about: [
      "Erewash Valley Gymnastics Club is a community-based registered charity with centres in Long Eaton and Ilkeston.",
      "Its Long Eaton centre offers gymnastics in a safe and friendly learning environment, with programmes ranging from preschool and recreational sessions to advanced pathways and adult gymnastics.",
      "The club also runs stay-and-play and inclusion sessions, holiday activities, workshops and children's birthday parties.",
    ],
    website: "https://www.evgc.co.uk/",
    telephone: "0115 972 6070",
    email: "gymnastics@evgc.co.uk",
    imageAlt: "Erewash Valley Gymnastics Club",
    imageLabel: "Community gymnastics club",
    imageStyle: "bg-[#dbe9f1]",
    featured: false,
    isReal: true,
  },
  {
    ...
    slug: "pqa-long-eaton",
    name: "PQA Long Eaton",
    category: "Performing Arts & Children",
    location: "Trent College and The Elms, Derby Road, Long Eaton, NG10 4AD",
    description:
      "Saturday performing arts classes in comedy and drama, musical theatre, and film and television for children and young people aged 4–18.",
    about: [
      "PQA Long Eaton is a weekend performing arts academy based at Trent College and The Elms.",
      "Saturday sessions give children and young people experience across comedy and drama, musical theatre, and film and television, while developing creativity, communication and confidence.",
      "The academy offers 90-minute Poppets classes for ages 4–6 and a three-hour Main Academy for ages 6–18, with a free introductory session available to new students.",
    ],
    website: "https://www.pqacademy.com/academies/long-eaton/",
    telephone: "07356 217116",
    email: "charlotte.burden@pqacademy.com",
    openingHours: [{ label: "Saturday: 9.45am–1pm", schema: "Sa 09:45-13:00" }],
    imageAlt: "PQA Long Eaton",
    imageLabel: "Weekend performing arts academy",
    imageStyle: "bg-[#eee2f1]",
    featured: false,
    isReal: true,
  },
  {
    id: "business-22",
    slug: "long-eaton-united-fc",
    name: "Long Eaton United FC",
    category: "Fitness & Sport",
    location: "Grange Park, Station Road, Long Eaton, NG10 2EF",
    description:
      "Long Eaton's community football club, playing home fixtures at Grange Park and supporting senior, youth and academy football.",
    about: [
      "Long Eaton United FC is based at Grange Park on Station Road, where supporters can watch the club's home fixtures.",
      "The club supports a range of teams and development pathways, with match details, results, club news and admission information published on its website.",
      "Grange Park also has a bookable 3G pitch, while an affiliated academy provides football and education opportunities for young players.",
    ],
    website: "https://www.longeatonutd.co.uk/",
    telephone: "0115 973 5700",
    imageAlt: "Long Eaton United FC",
    imageLabel: "Community football club",
    imageStyle: "bg-[#d9e7f4]",
    featured: false,
    isReal: true,
    relatedLinks: [
      {
        href: "https://www.longeatonutd.co.uk/matches",
