...
function EventCard($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (event.imageSrc) {
      $$renderer2.push("<!--[0-->");
      $$renderer2.push(`<div class="h-48 w-full overflow-hidden bg-brand-primaryDark/10"><img${attr("src", event.imageSrc)}${attr("alt", event.imageAlt ?? event.title)} class="h-full w-full object-cover"/></div>`);
    } else {
      $$renderer2.push("<!--[-1-->");
