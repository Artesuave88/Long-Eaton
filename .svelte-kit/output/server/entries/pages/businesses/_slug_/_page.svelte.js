...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (data.business.imageSrc) {
      $$renderer2.push("<!--[0-->");
      $$renderer2.push(`<div class="flex h-[24rem] w-full items-center justify-center overflow-hidden rounded-[1.75rem] bg-[#0b0b0b] p-10 shadow-card"><img${attr("src", data.business.imageSrc)}${attr("alt", data.business.imageAlt ?? data.business.name)} class="max-h-full max-w-full object-contain"/></div>`);
    } else {
      $$renderer2.push("<!--[-1-->");
